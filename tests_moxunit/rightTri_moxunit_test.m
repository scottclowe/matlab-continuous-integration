function test_suite=rightTri_moxunit_test
    initTestSuite
end

%% Test 1: sum of angles
function test_sum_of_angles()
    tri = [7 9];
    triIso = [4 4];
...
function test_small_angle_approximation()
    tri = [7 9];
    triIso = [4 4];
    tri306090 = [2 2*sqrt(3)];
    triSkewed = [1 1500];
